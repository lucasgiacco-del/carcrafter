...
const HERO_EXAMPLES: HeroExample[] = [
  ...
  {
    id: 'a4',
    name: 'Audi S4 – murdered daily',
    beforeSrc: '/hero-examples/s4-before.png',
    afterSrc: '/hero-examples/s4-after.png',
    summary: 'Lowered, 5% tint, OEM+ wheels, mild aero.',
    budget: '≈ $2.4k in parts',
  },
]
    ...
    <main className="min-h-screen bg-[#020308] text-white flex flex-col">
      ...
      <div className="flex-1 flex justify-center">
        <div className="w-full max-w-md px-4 pb-5 pt-2 flex flex-col gap-6">
          ...
          <section className="rounded-3xl border border-white/10 bg-gradient-to-br from-[#22123f] via-[#0a0716] to-[#050509] shadow-[0_26px_60px_rgba(0,0,0,0.9)] px-4 py-4 space-y-4">
            ...
            <div className="mt-2 rounded-2xl border border-white/10 bg-black/25 px-3 py-3 space-y-3">
              ...
              <div className="space-y-2">
                {HERO_EXAMPLES.map((example) => (
                  <div
                    key={example.id}
                    className="rounded-2xl border border-white/10 bg-[#050509] overflow-hidden shadow-[0_18px_45px_rgba(0,0,0,0.85)]"
                  >
                    <div className="w-full flex">
                      <div className="w-1/2 relative h-24 sm:h-28 border-r border-black/50">
                        <img
                        ...
                        <span className="absolute bottom-1.5 left-2 text-[9px] px-2 py-0.5 rounded-full bg-black/70 text-gray-100 uppercase tracking-[0.16em]">
                          Before
                        </span>
                      </div>
                      <div className="w-1/2 relative h-24 sm:h-28">
                        <img
